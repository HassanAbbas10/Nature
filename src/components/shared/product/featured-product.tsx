...
export async function FeaturedProductShowcase() {
  ...
  return (
    <div className="bg-white text-neutral-800 px-4 sm:px-8 md:px-12 ">
    <Carousel opts={{ align: "start", loop: true }} className="w-full">
      <div className="max-w-7xl mx-auto my-16 overflow-hidden ">
        {/* Header */}
        ...
        {/* Carousel */}
        <CarouselContent className="ml-0 p-6">
          {products.map((product: any) => (
            
            <CarouselItem
              key={product.id}
              className="px-5 py-8 basis-1/1 sm:basis-1/2 md:basis-1/3 lg:basis-1/4"
            >
