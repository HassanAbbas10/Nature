...
export const metadata = {
  title: "Order Success - Nature & Nurtures",
  description: "Thank you for your purchase! Your order has been confirmed successfully at Nature & Nurtures.",
  keywords: ["order success", "checkout complete", "payment successful", "shop", "Nature and Nurtures"],
  openGraph: {
    title: "Order Success - Nature & Nurtures",
    description: "Your order has been placed successfully! We appreciate your trust in Nature & Nurtures.",
    url: `${DOMAIN}/success`,
    ...
    images: [
      {
        url: `${DOMAIN}/order-success-banner.jpg`,
        width: 1200,
        height: 630,
        alt: "Order Successful - Nature & Nurtures",
      },
    ],
  },
  twitter: {
    ...
    title: "Order Success - Nature & Nurtures",
    description: "Thank you for shopping with Nature & Nurtures! Your order has been confirmed.",
    images: [`${DOMAIN}/order-success-banner.jpg`],
  },
};
