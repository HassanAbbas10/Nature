...
import { BlogPostSchema } from "@/seo/Jsonld";
...
export async function generateMetadata({
  ...
  if (!blog) {
    return {
      title: "Blog Not Found | Nature & Nurtures",
  ...
  const blogTitle = `${blog.title} | Nature & Nurtures`;
  ...
  const imageUrl =
    blog.featuredImage ||
    `${DOMAIN}/blog-default-banner.jpg`;
  const blogUrl = `${DOMAIN}/blogs/${slug}`;

  return {
    title: blogTitle,
    description: blogDescription,
    keywords: blog.tags || ["Nature & Nurtures", "blog", "natural living", "wellness"],
    openGraph: {
      title: blogTitle,
      description: blogDescription,
      url: blogUrl,
